...
#' data), then divided by the number of samples the sensor would record in an 
#' ideal day (30 samples/hour * 24 hours/day) to return a percentage of each day
#' that the sensor is performing optimally.
#' 
