...
aggregationStats <- pat_aggregateOutlierCounts(pat_state)
...
#     aggregationStats  = select(aggregationStats, datetime, pm25_A_count, pm25_A_max, pm25_A_mean, pm25_A_median,
...
#     aggregationStats  = select(aggregationStats, datetime, pm25_B_count, pm25_B_max, pm25_B_mean, pm25_B_median,
...
#     aggregationStats  = select(aggregationStats, datetime, temperature_count, temperature_max, temperature_mean,
