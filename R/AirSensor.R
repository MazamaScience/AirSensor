...
#' This dataset was generated by running \code{pas_loadLatest()} on 2019-05-14.
...
#' 
#' \code{pas <- enhanceSynopticData(example_pas_raw)}
#' @seealso example_pas
#' @source https://www.purpleair.com/json
NULL
...
#' was generated by running \code{pat_loadLatest()} for on a monitor
...
#' This dataset was generated by running \code{pat_loadLatest()} for the SCNP_20
#' sensor in Nipomo, California over a two-week interval, 2019-04-01 to 2019-04-18.
#' @seealso createPATimeseriesObject
NULL
...
#' version of a \emph{pa_timeseries} object for practicing and code development. 
#' This dataset was generated by running \code{pat_loadLatest()} for the SCTV_16
#' sensor in Los Angeles over a two-week interval, 2019-06-01 to 2019-06-18.
#' @seealso createPATimeseriesObject
NULL
...
#' a \emph{airsensor} object for practicing and code development. This dataset 
#' was generated by running \code{pat_createAirSensor} for on a monitor
#' from a timeseries generated by 
#' \code{
#' pat_load("SCAN_14", "20180801", "20181001")
#' }
#' @seealso pat_loadLatest
NULL