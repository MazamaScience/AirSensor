...
#' 
#' @title Apply Quality Control to a PAT object
#' 
...
#' 
#' The \code{pat_load()} function returns raw "engineering" data for a Purple
#' Air Sensor. The very first level of QC that should always be applied is the
#' removal of out-of-spec values that should never be generated by the sensor
...
#' 
#' @return A cleaned up \code{pat} object.
#' 
