...
pat_august <- 
  pat %>% 
  pat_subdate(sd = 20180801, ed = 20180901)
...
pat_august_filtered <- 
  pat_august %>%
  pat_findOutliers(replaceOutliers = TRUE, showPlot = TRUE)
```
...
using `pat_subdate` and `pat_multiplot`. 

```{r}
august_14 <- 
  pat_august %>% 
  pat_subdate(sd = 20180814, days = 1)
