...
if ( file.exists(filePath_jannali) ) {
  ...
  id_jannali <- pas_getDeviceDeploymentIDs(pas, pattern = "Jannali")
  pat_jannali <- pat_createNew(id = id_jannali,
                               label = label, 
                               pas = pas_au,
                               startdate = 20191229, 
                               enddate = 20200110)
...
if ( file.exists(filePath_downer) ) {
  ...
  id_bungendore <- pas_getDeviceDeploymentIDs(pas_au, 
                                              pattern = "Bungendore, NSW Australia" )
  pat_bungendore <- pat_createNew(id = id_bungendore, 
  ...
  id_downer <- pas_getDeviceDeploymentIDs(pas_au, pattern = "Downer")
  pat_downer <- pat_createNew(id = id_downer, 
                              label = "Downer",
                              pas = pas_au,
                              startdate = 20191220, 
                              enddate = 20200110)
