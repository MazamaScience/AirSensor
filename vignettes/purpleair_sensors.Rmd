...
In this process, however, calculating concentration relies on an assumed 
...
higher PM levels than federal monitors.
...
Other regulatory groups often give an AQI averaged over the last 24 hours, which
may appear to exaggerate the PurpleAir data on comparison. 
[Source](https://www2.purpleair.com/community/faq#!hc-how-do-purpleair-sensors-compare-to-regulatory-particulate-matter-sensors)
