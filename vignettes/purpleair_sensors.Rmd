...
counters of this type function by measuring light scattered by suspended 
particulate matter. The PMS5003 unit sends a laser through air sucked in by a 
fan, measures the light received, and calculates the number of different-sized 
particles based on 
