...
|:------|:-----|
| **Loading a `pat`** |  |
| `pat_load()` | `label , startdate, enddate` | 
| `pat_loadMonth()` | `label , datestamp` | 
| `pat_loadLatest()` | `pas, name, id, startdate, enddate` |
| **Mainpulating a `pat`** |  |
| `pat_filter()` | `pat, ...` |
...
| `sensor_load()` | `collection , startdate, enddate` | 
| `sensor_loadMonth()` | `collection , datestamp` | 
