...
| `pas_getColumn()` | `pas, name, states, pattern, isOutside, isParent` |
| `pas_getDeviceDeploymentIDs()` | `pas, states, pattern, isOutside, isParent` |
| `pas_getIDs()` | `pas, states, pattern, isOutside, isParent` |
| `pas_getLabels()` | `pas, states, pattern, isOutside, isParent` |
| **Mainpulating a `pas`** |  |
| `pas_filter()` | `pas, ...` |
