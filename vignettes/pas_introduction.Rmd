...
nearest official air quality monitor. For a more indepth explaination, see 
`enhanceSynopticData()`.
...
sensors that are reporting a weekly average of >20 PM2.5. 
...
df %>% 
  ...
  labs(x = "State", y = "Percent of PA sensors above 20 PM2.5") + 
