...
pat_a_noisy_2 <- pat_createNew(pas, label = "SCAP_14", 
...
pat <- pat_createNew(pas, "SCEM_05", startdate = 20190701, enddate = 20190710)
pat_multiplot(pat)
```

The multiplot shows the A and B channels have very different readings, similar 
the "Matches Humidity" failure mode. The strange thing here though is that the 
A channel is mostly flat, with only the occasional spike when the humidity 
