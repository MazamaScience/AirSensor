...
pat_a_noisy_1 <- example_pat_failure_B
...
sometimes the noise level goes far beyond what is allowable when measurements 
start bouncing around in an enormous range of ug/m3 within hours. Here we see 
the A channel looks like a cloud of points measuring anywhere from below 50 to 
over 1100 ug/m3. A very faint wave pattern can still be identified, however.
