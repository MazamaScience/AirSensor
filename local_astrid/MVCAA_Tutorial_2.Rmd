...
### Jon, is there a difference between federal monitor and PWFSL monitor. 

### I thought they were the same. Maybe we need a sentence to expain this. 

### Also, we have different agencies (e.g. AirNow, AIRSIS, etc), so what do we mean by 

### PWFSL monitor? for pat_externalFit(), the doc says "PWFSL monitor". 
