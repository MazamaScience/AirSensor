...
In the example below, we will use functions from **PWFSLSmoke** and **dplyr** 
to calculate some daily statistics for Pine Forest.
...
[PWFSLSmoke](http://mazamascience.github.io/PWFSLSmoke/) for data manipulation
and the 
