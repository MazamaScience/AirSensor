...
```{r Setup new data directory, eval = TRUE}
# ----- Setup new data directory -----------------------------------------------
# check your current home directory 
path.expand("~")

# create a new data directory 
DATA_DIR <- "~/Data/MVCAA" # type yours changing only "~" and keeping "/Data/MVCAA". Example: "C:/MethowValley/Data/MVCAA" 
```

```{r create_archive setup, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r create_archive pas object, eval = TRUE, warning = FALSE, message = FALSE}
# ----- Create PAS object ------------------------------------------------------
...
list.files(file.path(archiveDir)) #had to add file.path()
```

```{r create_archive pat object, eval = TRUE, warning = FALSE, message = FALSE}
# ----- Create PAT objects -----------------------------------------------------
...
# Jon -- evaluate if we should include a test section like the one below 
...
# Remove mvcaa from your current environment to ensure we're using our local archive

rm(list = ls()) #this would remove the archiveDir object and complicate things for those who created a new DATA_DIR previously. Is there a way to leave archiveDir in the environemt? 
