...
#sampled_b <- pat_bikesvg$data # Unsampled and noisy
#sampled_b <- pat_sample(pat_bikesvg, 5000)$data # Sampled, but draws gaps at NA points
sampled_b <- na.omit(pat_sample(pat_bikesgv, 5000)$data) # Sampled with no gaps, but have to na.omit once sampled
pm25_b <- sampled_b[, c("datetime", "pm25_B")]
plot(pm25_b, type = "l", main = "PM 2.5 Channel B", 
